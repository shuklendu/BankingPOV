    ...
    angular.element(document).ready(function () {
        ...
        setTimeout(function() {
            $.gritter.add({
                ...
                text: 'You last logged in at 1405 on Jul/7/2016',
...
colorAdminApp.controller('dashboardV2Controller', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        ...
        Morris.Bar({
            ...
            data: [
                {device: 'Jul15', geekbench: 336},
                {device: 'Aug15', geekbench: 237},
                {device: 'Sep15', geekbench: 275},
                {device: 'Oct15', geekbench: 380},
                {device: 'Nov15', geekbench: 255},
                {device: 'Dec15', geekbench: 471},
                {device: 'Jan16', geekbench: 336},
                {device: 'Feb16', geekbench: 337},
                {device: 'Mar16', geekbench: 375},
                {device: 'Apr16', geekbench: 380},
                {device: 'May16', geekbench: 455},
                {device: 'Jun16', geekbench: 471}
            ],
            xkey: 'device',
            ykeys: ['geekbench'],
            labels: ['Income'],
        ...
        var blue = '#348fe2';
        Morris.Donut({
            element: 'expenses-donut-chart',
            data: [
                {label: "Payroll", value: 36892},
                {label: "Office Supplies", value: 8268},
